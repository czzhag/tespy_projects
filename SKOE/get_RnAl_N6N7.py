...
class opts:
	...
	date = '20210423'
	module = 'BA30N6N7'
	runn = '%s_%s_%s_Al'%(date,testbed,module) # output path
	fn300 = 'LC_light_ba_FPU349mK_datamode1_source300K_run2' 
	fn077 = 'LC_light_ba_FPU349mK_datamode1_source077K_run2'
